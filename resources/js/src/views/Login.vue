<template>
<div class="main-area">
  <div v-if="showerror" class="mycolor v-snack v-snack--active v-snack--right v-snack--text v-snack--top" style="padding-bottom: 0px; padding-top: 0px;">
...
export default {
  ...
  computed: {
    ...
    cardBgImage() {
      return {
        backgroundImage: `url(/images/LoginCard.jpg)`
      };
    }
  },
  methods: {
...
.main-area {
  ...
  overflow: hidden;
  background-image: url("/images/loginbg.png?dpr=2&auto=compress,format&fit=crop&w=1199&h=811&q=80&cs=tinysrgb&crop=");
