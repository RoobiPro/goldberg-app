   ...
   <template v-slot:default="dialog">
     <v-card>
       ...
       <div class="d-flex flex-column pt-5">
         ...
         >
         <v-radio
           label="Drilling Sample List"
           value="drilling/samplelist"
         >
         </v-radio>
         <v-radio
           label="Wells Sample List"
           value="well/samplelist"
         >
         </v-radio>
         <v-radio
           label="Hand Samples Sample List"
           value="handsample/samplelist"
         >
         </v-radio>
       </v-radio-group>
       <hr id="vaddershr">
