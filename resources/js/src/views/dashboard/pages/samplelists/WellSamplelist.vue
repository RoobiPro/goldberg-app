...
export default {
    ...
    async created() {
      ...
      await this.$store.dispatch("ProjectsManager/getProjectWellSampleList", this.$route.params.id);
      this.samplelist = this.$store.getters["ProjectsManager/projectwellsamplelist"];
      this.ready=true
